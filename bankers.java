//tells which resource will come,how many resources will they request,and for how long
//have to give the information earlier
//have different type of resouces
//allocation tells how many resources system has already given to particular process
////max. need, which resouces want how much resources
//avaibility, total avaibility
...
class bankers {
    ...
    public void isSafe(){
        ...
        while(j<np)
        {  //loop until all process allocated
